# Contributing to the Text Classification with TensorFlow Lite and Firebase on Android Codelab

We'd love for you to contribute to our source code and to make the Text Classification with TensorFlow Lite and Firebase Codelab even better than it is today! Here are the guidelines we'd like you to follow:
...
As contributors and maintainers of the Text Classification with TensorFlow Lite and Firebase Codelab project, we pledge to respect everyone who contributes by posting issues, updating documentation, submitting pull requests, providing feedback in comments, and any other activities.
...
If any member of the community violates this code of conduct, the maintainers of the Text Classification with TensorFlow Lite and Firebase project may take action, removing issues, comments, and PRs or blocking accounts as deemed appropriate.
...
If you have questions about how to use the Firebase FriendlyChat Codelab, please direct these to [StackOverflow][stackoverflow] and use the `firebase` and `tensorflow-lite` tag. We are also available on GitHub issues.
...
* Search [GitHub](https://github.com/FirebaseExtended/codelab-text-classification-android/pulls) for an open or closed Pull Request
...
[github]: https://github.com/FirebaseExtended/codelab-text-classification-android
